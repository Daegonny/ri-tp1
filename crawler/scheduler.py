...
class Scheduler():
    ...
    def count_fetched_page(self):
        ...
        Imprime mensagem se atingir fim da coleta.
        """
    ...
    def get_next_url(self):
        ...
        Se nenhum domínio estiver disponível retorna o tempo necessário a ser esperado pelo fetcher.
        """
    ...
    def collect_url(self, obj_url):
        """
        Marca que uma URL foi coletada e adiciona na lista
        """
    ...
    def save_collected_urls(self):
        """
        Imprime URLs coletadas em arquivo
        """
